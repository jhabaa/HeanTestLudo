...
namespace Assets
{
    public class Feuille
    {
        ...
        public void SetValues(List<GameObject> A)
        {
            arene = A;
        }
        public void SetValues(List<GameObject> A, int S)
        {
            arene = A;
            score = S;
        }
        ...
        public List<String> ShowTree()
        {
            ...
            foreach (Feuille A in branche)
            {
                ...
                if(A.branche.Count > 0)
                {
                    ...
                    {
                        List<GameObject> gameObjects2 = B.arene;
                        foreach(GameObject gameObject2 in gameObjects2)
                        {
                            result.Add(gameObject2.name);
                        }
                    }
                }
            }
